...
/* "Male fertility, explained" — an "Educate IVF · Conditions" piece. Each section
 * is either a prose paragraph or a bulleted list, with an optional intro line.
 * All copy is localised via the ArticleMaleFertility namespace so it reads
...
export function MaleFertilityArticle({
  article,
  allArticles,
}: {
  article:     Article
  ...
  const t       = useTranslations('ArticleMaleFertility')
  ...
  const sections = t.raw('sections') as MFSection[]
