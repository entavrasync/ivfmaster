...
export const metadata = {
  title: 'Learn About Fertility & IVF - IVF Master Educate Hub',
  description: 'Educational guides about IVF, fertility, PCOS, male fertility, and more. Clear, jargon-free fertility education.',
};
